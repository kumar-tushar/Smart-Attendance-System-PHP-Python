...
<div class='page-header'>
		<div class="row">
			<div class="col-md-4">
				<div class="col-md-4">
					<a href="manage-attendence.php" class="btn btn-success btn-block mw-50">Home</a>
				</div>
			</div>
			<div class="col-md-4">
			</div>
			<div class="col-md-4">
				...
				<div class="col-md-4">
					<!--<a href="add-new-subject.php" class="btn btn-warning btn-block mw-50"></a>-->
				</div>
			</div>
		</div>
...
<body background="../images/diary-92652_1920.jpg" class="text-center">
        ...
        <div class="table-scrol">
             ...
             <h1 align="center">Attendance of class  <?php echo $_GET['class']; ?></h1>
                ...
                <table class="table table-bordered table-hover table-striped" >
                    ...
                    <tr>
                        ...
                        <?php  // print date on top of table
							...
							$date_list = "SELECT * FROM `attendances` WHERE `rfid`=\"$rf_id\" AND `class`=\"$class\" AND `sub`=\"$sub\" ORDER BY `id` ASC";
